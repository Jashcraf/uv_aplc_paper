...
\textcolor{red}{Roser, Kyle, Saraswathi, Ramya, please comment}
...
For ease of alignment, we baseline a circular lyot stop at 
...
\section{Evaluating Throughput, Low-order Aberration Sensitivity of point designs}
\label{sec:point_design}

\section{Can the bandwidth be optimized to maximize throughput?}
Contrast and throughput v.s. $1\%$ steps in bandwidth  - allows for solving characterization with arbitrary spectrum. 
